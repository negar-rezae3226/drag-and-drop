class draggable {
    ...
    handleDragDrop(e) {
        let target = e.target.closest('.list-item');//به نزدیک ترین ایتم که این کلاس تو خودش داره دسترسی پیدا میکنیم
       ...
       if(this.dragSrcEl != target) {
            ...
            this.addDnDHandlers(target.previousSibling)//این دستور برای این که اگر یک ایتمی را جابه جا کردیم بعد دوباره خواستیم آن را جا به جا کنیم بشود
       }
       e.target.classList.remove('over');
